...
class MotorStepper(object):
     ...
     """Manually reversed the step stats array - 29/4/17 - MG"""
     step_states_reverse = (0x8, 0x9, 0x1, 0x5, 0x4, 0x6, 0x2, 0xa)
     ...
     def reverse(self, steps, step_delay):
         """Sets the motor so that it is moving in reverse."""
#         self._send_steps(reveresed(self.step_states), steps, step_delay)         
         """Manually reversed the step stats array - 29/4/17 - MG"""
         self._send_steps(self.step_states_reverse, steps, step_delay)
